...
var ExpenseTaxItemWhere = struct {
	...
	Gross:     whereHelpernull_Int{field: "\"expense_tax_items\".\"gross\""},
	Tax:       whereHelpernull_Int{field: "\"expense_tax_items\".\"tax\""},
}
...
func (o *ExpenseTaxItem) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"expense_tax_items\"", updateOnConflict, ret, update, conflict, insert)
