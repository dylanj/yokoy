...
var (
	invoiceDBTypes = map[string]string{`ID`: `text`, `LegalEntityID`: `text`, `Country`: `text`, `Currency`: `text`, `Duedate`: `timestamp without time zone`, `Date`: `timestamp without time zone`, `GrossAmount`: `numeric`, `InvoiceNumber`: `text`, `IsCreditNode`: `boolean`, `NetAmount`: `numeric`, `PaymentTermID`: `text`, `PostingDate`: `timestamp without time zone`, `PurchaseOrderIds`: `ARRAYtext`, `ServiceDate`: `timestamp without time zone`, `Status`: `text`, `Submitters`: `ARRAYtext`, `SupplierID`: `text`, `TaxableAmount`: `numeric`, `BankAccount`: `text`, `BankCountry`: `text`, `BankKey`: `text`, `BankNumber`: `text`, `ExternalID`: `text`, `Iban`: `text`, `SwiftCode`: `text`}
	_              = bytes.MinRead
)
