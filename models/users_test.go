...
var (
	userDBTypes = map[string]string{`ID`: `text`, `CostCenterID`: `text`, `Email`: `text`, `EmployeeID`: `integer`, `FirstName`: `text`, `Language`: `text`, `LastName`: `text`, `LegalEntityID`: `text`, `LineManagerID`: `text`, `LineManagerThreshold`: `integer`, `PolicyID`: `text`, `StatusActive`: `boolean`, `SubmissionDelegateID`: `text`}
	_           = bytes.MinRead
)
