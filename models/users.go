...
type User struct {
	...
	LineManagerThreshold null.Int    `boil:"line_manager_threshold" json:"line_manager_threshold,omitempty" toml:"line_manager_threshold" yaml:"line_manager_threshold,omitempty"`
	...
	SubmissionDelegateID null.String `boil:"submission_delegate_id" json:"submission_delegate_id,omitempty" toml:"submission_delegate_id" yaml:"submission_delegate_id,omitempty"`
...
var UserWhere = struct {
	...
	CostCenterID:         whereHelpernull_String{field: "\"users\".\"cost_center_id\""},
	Email:                whereHelpernull_String{field: "\"users\".\"email\""},
	EmployeeID:           whereHelpernull_Int{field: "\"users\".\"employee_id\""},
	FirstName:            whereHelpernull_String{field: "\"users\".\"first_name\""},
	Language:             whereHelpernull_String{field: "\"users\".\"language\""},
	LastName:             whereHelpernull_String{field: "\"users\".\"last_name\""},
	LegalEntityID:        whereHelpernull_String{field: "\"users\".\"legal_entity_id\""},
	LineManagerID:        whereHelpernull_String{field: "\"users\".\"line_manager_id\""},
	LineManagerThreshold: whereHelpernull_Int{field: "\"users\".\"line_manager_threshold\""},
	PolicyID:             whereHelpernull_String{field: "\"users\".\"policy_id\""},
	StatusActive:         whereHelpernull_Bool{field: "\"users\".\"status_active\""},
	SubmissionDelegateID: whereHelpernull_String{field: "\"users\".\"submission_delegate_id\""},
}
...
var (
	userAllColumns            = []string{"id", "cost_center_id", "email", "employee_id", "first_name", "language", "last_name", "legal_entity_id", "line_manager_id", "line_manager_threshold", "policy_id", "status_active", "submission_delegate_id"}
	userColumnsWithoutDefault = []string{"id"}
	userColumnsWithDefault    = []string{"cost_center_id", "email", "employee_id", "first_name", "language", "last_name", "legal_entity_id", "line_manager_id", "line_manager_threshold", "policy_id", "status_active", "submission_delegate_id"}
