...
var (
	invoiceLineItemDBTypes = map[string]string{`ID`: `integer`, `InvoiceID`: `text`, `CategoryID`: `text`, `CostObjectID`: `text`, `Description`: `text`, `Gross`: `integer`, `ItemPrice`: `integer`, `Net`: `integer`, `PurchaseOrderID`: `text`, `PurchaseOrderItemID`: `text`, `Quantity`: `integer`, `Tags`: `text`, `TaxRateID`: `text`, `Unit`: `text`}
	_                      = bytes.MinRead
)
